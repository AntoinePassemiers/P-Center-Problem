...
For example, P3-BINARY selects 10 centers while P3-DB3 selects only 9 centers on instance \textit{easy/instance20\_10\_2} (Cbc).
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.68\textwidth]{../imgs/binary_bounds.png}\\
        Search space of BINARY algorithm for finding the lower bound \\ on easy/instance10\_1\_1.dat
    \end{center}
\end{figure}\ \\
...
\begin{figure}[h!]
    \begin{center}
        \includegraphics[width=0.68\textwidth]{../imgs/db3_bounds.png}\\
        Evolution of lower and upper bounds using DB3 \\ algorithm on instance hard/instance9.dat
    \end{center}
\end{figure}
